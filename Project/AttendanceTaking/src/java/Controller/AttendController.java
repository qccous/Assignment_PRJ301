...
//        String time= (String) session.getAttribute("weekly");
...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DAOAttend dao = new DAOAttend();
        HttpSession session = request.getSession(true);
        List<StudentByClass> list = (List<StudentByClass>) session.getAttribute("list");
        for (StudentByClass s : list) {
            String status = request.getParameter(""+s.getStudentId());
            dao.upDateAttendance(Integer.parseInt(status), s.getStudentId());
        }
        response.sendRedirect("checkAttend");
    }
